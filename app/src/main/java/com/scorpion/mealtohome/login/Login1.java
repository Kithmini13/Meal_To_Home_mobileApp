        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(etPhoneNo.getText().toString())) {
                    ...
                    Toast.makeText(Login1.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
                    // if the text field is not empty we are calling our
                    // send OTP method for getting OTP from Firebase.
                    String phone = "+94" + etPhoneNo.getText().toString();
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(etPhoneNo.getText().toString())) {
                    ...
                    Toast.makeText(Login1.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(Login1.this, Menu1.class);
                            startActivity(i);
                            finish();
                        } else {
